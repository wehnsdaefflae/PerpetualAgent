...
DOCSTRING_WRITER = (
    ...
    "solve the task above. Don't incorporate literal information from the task description but use "
    "function arguments to make sure that the function can be applied to other tasks as well.\n"
    "\n"
