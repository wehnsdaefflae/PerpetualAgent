...
class Model:
    def __init__(self, trigger_new_agent: Callable[[Agent], None]) -> None:
        ...
        self.action_storage = ActionStorage(_actions=ACTIONS)   # same data source as in agent.Agent
        self.fact_storage = FactStorage(_facts=FACTS)           # same data source as in agent.Agent
